...
#define STRING_CONFIG_H_AUTHOR "gif30" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "gif30-corexy"
...
/* HOW TO PID https://www.youtube.com/watch?v=h9Rdid-T-Gw
 * M502 (optional, load factory config)
 * M501 (optional, load eeprom config)
 * M303 S215 C10 (start PID test)
 * M301 Pxx.xx Ix.xx Dxx.xx (Load new PID values)
 * M500 save on eeprom
 */

// Titan Aero 215 grad Celcious
...
//3000, 3000, 100, 10000 //modify_ger
...
#define INVERT_X_DIR false //modify_ger
#define INVERT_Y_DIR true  //modify_ger
#define INVERT_Z_DIR false //modify_ger
...
/**
   ...
   */
//#define G26_MESH_VALIDATION //modify_ger
...
//#define BED_CENTER_AT_0_0   //modify_ger
